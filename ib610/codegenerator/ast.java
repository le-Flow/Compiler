...
class PrintStmtNode extends StmtNode {
    ...
    public void codeGen() {
        // Code für den Ausdruck generieren (Ergebnis landet auf dem Stack)
        myExp.codeGen();
        ...
        if (printType == Types.IntType) {
            ...
            // True-Fall
            Codegen.generate("la", Codegen.ACC, ".true_msg");
            ...
            Codegen.generate("la", Codegen.ACC, ".false_msg");
            Codegen.generate("li", Codegen.V0, 4);
            Codegen.generate("syscall");
        ...
        // Neue Zeile drucken (Vorgabe aus PDF)
...
class CallExpNode extends ExpNode {
    ...
    public void codeGen() {
        ...
        // Rückgabewert ($v0) auf Stack retten
...
class NotNode extends UnaryExpNode {
    ...
    public void codeGen() {
        myExp.codeGen();
        Codegen.genPop(Codegen.T0);
        Codegen.generate("not", Codegen.ACC, Codegen.T0);
        Codegen.genPush(Codegen.ACC);
    }
